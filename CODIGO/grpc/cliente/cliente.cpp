...
// Clase cliente mantiene un att. que representa el _stub (del cliente) y se añade un método DiHola
...
public:
    ...
    std::string DiHola(const std::string& nombre) {
        ...
        // Llamada al rpc: Status representa el resultado: ok / error
...
int main()
{
    // Crear el cliente y ejecutar el metodo:
